			...
			<div class="row">
			  <div class="col-12">
				<div class="box">
				  ...
				  <div class="box-body">
					<form action="{{ route('admin.paper.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
						<div class="form-body">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="text" name="paper_name" value="{{ $paper->paper_name }}" required class="form-control" placeholder="Past Paper Name">
									</div>
								</div>
								<!--/span-->
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-select" required name="year" data-placeholder="Choose a Year of Paper" tabindex="1">
                                            <option selected  value="{{ $paper->year }}">{{ $paper->year }}</option>
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select class="form-select" name="subject" required data-placeholder="Choose a Subject" tabindex="1">
                                            <option selected  value="{{ $paper->subject }}">{{ $paper->subject }}</option>
										</select>
									</div>
								</div>
								<!--/span-->
										...
										<div class="radio-list">
											<label class="radio-inline p-0 me-10">
												<div class="radio radio-info">
													<input type="radio" @if($paper->status == 1)  @checked(true) @endif name="status" id="radio1" value="1">
													<label for="radio1">Published</label>
												</div>
											</label>
											<label class="radio-inline">
												<div class="radio radio-info">
													<input type="radio" name="status" @if($paper->status == 0)  @checked(true) @endif id="radio2" value="0">
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<div class="product-img text-start">
										<img id="image_user" src="{{ url("$paper->image") }}" alt="">
										<div class="input-group my-3">
										  <label class="input-group-text btn-primary" for="inputGroupFile01">Upload Anonther Image</label>
										  <input onchange="doAfterSelectImage(this)" name="image"  accept=".jpg,.jpeg,.png"  type="file"  class="form-control" id="inputGroupFile01">
										</div>
                                        @error('image')
