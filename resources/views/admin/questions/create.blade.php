				  ...
				  <div class="box-body">
					<form action="{{ route('admin.question.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
									  ...
									  <input type="tel" name="question_number" required class="form-control" placeholder="Questions Number">
									</div>
								</div>
                            </div>
							<div class="row">
								...
								<div class="col-md-12">
									...
									<div class="product-imgs text-start" >
										<img id="image_user" src="{{ asset('admin_assets/images/paper/sample_image.jpg') }}" alt="" style="width: 1650px;height: 300px;" >
										<div class="input-group my-3">
										  <label class="input-group-text btn-primary" for="inputGroupFile01">Upload Anonther Image</label>
										  <input onchange="doAfterSelectImage(this)" name="question_image"  accept=".jpg,.jpeg,.png"  type="file" required class="form-control" id="inputGroupFile01">
										</div>
						...
						<div class="form-actions mt-10">
                            <button type="submit" name="button" value="create_new" class="btn btn-primary"> <i class="fa fa-check"></i> Save & Create New</button>
							<button type="submit"  name="button" value="save" class="btn btn-primary"> <i class="fa fa-check"></i> Save</button>
